  ...
  return (
    <section className="relative w-full h-[500px] mt-10">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center text-white">
        ...
        Empowering Human Resources <br />  with AI Innovations
        </h1>
        <div className="flex gap-y-2 items-center flex-col sm:flex-row mx-auto sm:bg-white rounded-full p-2 shadow-md ">
          ...
          />
          <button className="flex items-center  px-4 py-2  text-black bg-lime-300 rounded-full font-semibold hover:bg-cyan-400">
            Join now
