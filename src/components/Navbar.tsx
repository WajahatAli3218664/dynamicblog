      ...
      <nav className="max-w-screen-2xl mx-auto flex justify-between h-20 items-center md:px-12 px-4">
        <div className="flex items-center justify-between  w-full md:w-auto">
          <div className="flex items-center">
            <Image
              src="/AI.png"
              alt="TalentPulse AI-logo"
              height={60}
              width={60}
              className="mt-1 "
            />
           <span className="text-2xl font-semibold hover:text-indigo-500">TalentPulse AI</span>
          </div>
        ...
        <ul className="hidden md:flex items-center gap-8 text-xl hover:text-indigo-500">
          <li>
            <Link href="/">Home</Link>
          </li>
          <li>
        ...
        <div className="hidden md:flex items-center">
          <button className="text-lg hover:text-indigo-500">Sign in</button>
