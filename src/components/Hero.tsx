    ...
    <>
      <section className="relative w-full h-screen pt-10">
        ...
        className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center text-white ">
          ...
          Revolutionizing Human Resources <br /> through the Power of Artificial Intelligence
          </h1>
          <p className="text-lg md:text-xl mb-8 ">
          Harnessing AI to transform talent acquisition, employee engagement, and workforce planning for smarter, more efficient, and inclusive HR practices.
          </p>
